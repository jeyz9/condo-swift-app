...
const CondoCardThird = () => {
return (
    <div className="card bg-base-100 shadow-lg overflow-hidden rounded-[12px] transition delay-50 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110">
